class Project:
    def __init__(self, id = None, project_name = None, client_id = None, client_royalties_address = None, contract_address = None, blockchain_symbol = None, ativo = None, statusupdatedate = None, currency = None, currencycrypto = None, setupfee = None, maintenancefee = None, primarysalefee = None, secondarysalefee = None, pixfee = None, min_pixfee = None, creditcardfee = None, connect = None, activeuser = None, wallet = None):
