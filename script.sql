...
drop table if exists finance.movements_crypto;

create table finance.movements_crypto(
id varchar(100) not null primary key,
...
gasFee float,
total float,
tokenName varchar(400),
tokenSymbol varchar(400),
tokenDecimal int,
isError int,
txreceipt_status int,
type varchar(100),
methodId varchar(100),
functionName varchar(300),
txnType varchar(20),
